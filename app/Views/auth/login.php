...
<head>
    ...
    <title>Login — Super Disparador AZ</title>
...
<body
    ...
    <div class="w-full max-w-md">
        <!-- Logo -->
        <div class="text-center mb-8 animate-fade-in" style="animation: fadeIn 0.5s ease-out;">
            ...
            <h1 class="text-3xl font-bold text-white">Super Disparador</h1>
            <p class="text-indigo-300 mt-1">WhatsApp Marketing com IA</p>
        </div>
        ...
        <div class="bg-white/10 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-white/20">
            ...
            <div class="mt-6 text-center">
                <p class="text-indigo-300 text-sm">
                    Não tem conta?
                    <a href="/register" class="text-green-400 hover:text-green-300 font-medium transition-colors">Criar
                        conta</a>
                </p>
            </div>
        </div>

        <p class="text-center text-indigo-400/50 text-xs mt-8">Super Disparador AZ &copy;
            <?= date('Y') ?>
        </p>
    </div>
